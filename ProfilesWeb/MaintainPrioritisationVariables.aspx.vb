...
#Region " Events "
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        btnUpdate.Attributes.Add("onclick", "if (!Page_IsValid) {document.getElementById('" & lblError.ClientID & "').innerText = 'Please correct validation errors to continue'; } else {return confirm('Are you sure you wish to update the global prioritisation variables?');};")
...
#End Region
    ...
    Private Sub PersistCriterionValues()
        ...
        If (Not SelectedPrioritisationCategory Is Nothing) Then
            ...
            criterion.Name = txtCriterionName.Text
