<%@ Page Language="VB" MasterPageFile="~/ProfilesTemplate.master" AutoEventWireup="false"
    CodeFile="EditProfileAllRevisionDates.aspx.vb" Inherits="EditProfileAllRevisionDates"
    ...
    <div class="TabBody">
        ...
        <asp:Panel ID="panRevDates" runat="server" Visible="true">
            ...
            <div class="collapsePanel">
                ...
                <br />
                <b>2. Geographic distribution & levels of disease</b>
                <table>
	                <tr>
		                <td>
		                ...
		                <td>
			                ...
			                <act:CalendarExtender runat="server" ID="CalNextAuthorReviewGeographicDistributionLevelsDisease" CssClass="ProfilesCalendar"
				                TargetControlID="txtNextAuthorReviewGeographicDistributionLevelsDisease" Format="d MMMM yyyy" PopupButtonID="ImgCalNextAuthorReviewGeographicDistributionLevelsDisease">
			                </act:CalendarExtender>
		                </td>
		                <td>
                ...
                <br />
                <b>4. Characteristics of the agent</b>
                <table>
	                <tr>
		                <td>
                ...
                <br />
                <b>14. Opportunity to add value</b>
                <table>
	                <tr>
		                <td>
                ...
                <br />
                <b>15. Public and Stakeholder Perception</b>
                <table>
	                <tr>
		                <td>
