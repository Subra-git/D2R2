...
Namespace ProfilesWeb.Controls
    ...
    Public Class SearchResultList
        ...
        Public Sub FilterList(ByVal displayPublished As Boolean, ByVal displayDraft As Boolean, ByVal displayScenarios As Boolean, _
            ...
            Dim filteredList As Csla.FilteredBindingList(Of ProfileInfo) = mResultList.GetFilteredList(displayPublished, displayDraft, displayScenarios, displayMyProfiles, filterLetter, title, speciesList)
