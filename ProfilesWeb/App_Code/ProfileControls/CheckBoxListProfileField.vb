    ...
    Public Class CheckBoxListProfileField
        ...
        Protected Overrides Sub CreateChildControls()
            ...
            If mField.ReferenceTableIsMaintainable Then
                ...
                For Each referenceItem As ReferenceValueInfo In mReferenceList
                    ...
                    mCheckboxLabels.Add(referenceItem.Value & IIf(referenceItem.IsActive, String.Empty, " (inactive)"))
                Next
            Else
        ...
        Protected Overrides Sub Render(ByVal writer As System.Web.UI.HtmlTextWriter)
            ...
            For Each box As CheckBox In mCheckboxList
                ...
                If Not box.Enabled AndAlso box.Visible Then
                    If box.Checked Then
                ...
                If boxVisible Then
                    ...
                    If box.Visible Then
                        'make sure they can tick and untick the box by clicking on the label
                        writer.AddAttribute(HtmlTextWriterAttribute.Onclick, box.ClientID & ".checked = !" & box.ClientID & ".checked")
                    End If
