...
Partial Class Notes
    ...
    Private Property SelectedNoteTypeInfo() As NoteTypeInfo
        Get
            If Not Session("SelectedNoteTypeInfo") Is Nothing Then
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            master.ProfileTitle = profileVersionInfo.ToString()
    ...
    Protected Sub ddlNoteType_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlNoteType.SelectedIndexChanged
        ...
        If ddlNoteType.SelectedIndex > 0 Then
            ...
            divNoteHeader.InnerText = SelectedNoteTypeInfo.PluralName
    ...
    Protected Sub dsNoteList_SelectObject(ByVal sender As Object, ByVal e As Csla.Web.SelectObjectArgs) Handles dsNoteList.SelectObject
        ...
        If (Not SelectedNoteTypeInfo Is Nothing) Then
    ...
    Protected Sub grdNotes_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdNotes.RowCommand
        ...
        If e.CommandName = "EditNote" Then
            ...
            divAddEditNoteTitle.InnerText = "Add/edit " & SelectedNoteTypeInfo.Name.ToLower()
            ...
            For Each cell As TableCell In e.Row.Cells
                For Each cellControl As Control In cell.Controls
                    ...
                    If confirmExtender IsNot Nothing Then
                        confirmExtender.ConfirmText = "Are you sure you want to delete this " + SelectedNoteTypeInfo.Name.ToLower + "?"
                    End If
                Next
            Next
        End If
