...
Partial Class EditNoteUI
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        divNoteHeader.InnerText = mNoteTypeInfo.Name
    ...
    Private Sub LoadAddText()
        ...
        Else
            lblSelectNote.Text = "There are no " + mNoteTypeInfo.Name.ToLower() + " in the master list. "
    ...
    Protected Sub dsAvailableNoteList_SelectObject(ByVal sender As Object, ByVal e As Csla.Web.SelectObjectArgs) Handles dsAvailableNoteList.SelectObject
        ...
        If Not EditProfileVersionInfo.Id.Equals(Guid.Empty) Then
    ...
    Private Sub SwitchToNoteEditView(ByVal note As Note, ByVal isSelecting As Boolean)
        ...
        If note Is Nothing Then
            ...
            Else
                ...
                divAddEditNoteTitle.InnerText = "Add a " + mNoteTypeInfo.Name.ToLower
    ...
    Protected Sub grdNotes_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdNotes.RowCreated
        ...
        If e.Row.RowType = DataControlRowType.Header Then
            If e.Row.Cells(0).Controls.Count > 0 AndAlso TypeOf e.Row.Cells(0).Controls(0) Is LinkButton Then
            ...
            For Each cell As TableCell In e.Row.Cells
                For Each cellControl As Control In cell.Controls
                    ...
                    If buttonField IsNot Nothing Then
                        ...
                        End If
                    End If
                    Dim confirmExtender As AjaxControlToolkit.ConfirmButtonExtender = TryCast(cellControl, AjaxControlToolkit.ConfirmButtonExtender)
                    If confirmExtender IsNot Nothing Then
                        confirmExtender.ConfirmText = "Are you sure you want to delete the association to this " + mNoteTypeInfo.Name.ToLower + "?"
                    End If
                Next
            Next
        End If
    ...
    Private Sub LoadCheckBoxes()
        ...
        For Each question As ProfileQuestionInfo In questionInfoList
            ...
            If Not CurrentNote Is Nothing Then
    ...
    Protected Sub ddlNotes_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlNotes.SelectedIndexChanged
        ...
        If ddlNotes.SelectedIndex > 0 Then
            ...
            txtCurrentNote.Text = selectedNote.NoteText
        Else
