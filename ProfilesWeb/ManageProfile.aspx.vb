...
Partial Class ManageProfile
    ...
    Private Sub RefreshDisplay(ByVal profileData As ProfilesLibrary.Profile)
        ...
        Page.Title = "Manage profile: " & profileData.ToString()
        ...
        lnkProfileProperties.Visible = ProfilesLibrary.Profile.CanEditProfile() AndAlso _
        ...
        lnkNewDraftVersion.Text = String.Format("Create new draft version {0}.{1}", _
                profileData.LatestVersion.VersionMajor.ToString(), _
        ...
        If Not SetProfileVersionPublicAccessCommand.CanChangePublicAccess(profileData.Id) OrElse _
