...
Namespace DataContracts
    ...
    <DataContract()> _
    Public Class UpdateProfileQuestionRequest
        ...
        Public Sub New(ByVal id As Guid, ByVal name As String, _
                       ByVal shortName As String, ByVal nonTechnicalName As String, _
                       ByVal questionNumber As Integer, ByVal userGuidance As String, _
                       ByVal lastUpdated As Byte())
            mId = id
            mName = name
            mShortName = shortName
            mNonTechnicalName = nonTechnicalName
            mQuestionNumber = questionNumber
            mUserGuidance = userGuidance
