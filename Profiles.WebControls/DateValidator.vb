    ...
    Public Class DateValidator
        ...
        Protected Overrides Function EvaluateIsValid() As Boolean
            ...
            If IsLargeDate Then
                ...
                If Convert.ToDateTime(value) > CDate(("31 December 9999")) Then
                    Return False
                End If

                If Convert.ToDateTime(value) < CDate(("1 January 1753")) Then
                    Return False
                End If
            Else

                'Test for the maximum and minimum dates allowed by a smalldatetime
                If Convert.ToDateTime(value) > CDate(("06/06/2079")) Then
                    Return False
                End If

                If Convert.ToDateTime(value) < CDate(("01/01/1900")) Then
                    Return False
                End If
            End If
