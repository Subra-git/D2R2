...
Namespace Profiles.WebControls.ProfileControls
    ...
    Public Class PerSpeciesListPanel
        ...
        Private mSpeciesPicker As SelectSpeciesOptionPicker
        ...
        Protected Overrides Sub CreateChildControls()
            ...
            For Each species As ProfiledSpecies In mProfiledSpeciesList
                ...
                If mFieldList.FieldListIsReadOnly Then
                    editLink.Text = "View"
                    editLink.Attributes.Add("aria-label", "Click this view link to display the details of the species.")
                Else
                    editLink.Attributes.Add("aria-label", "Click this edit link to make changes to the details of the species.")
                    editLink.Text = "Edit"
                End If
            ...
            mSpeciesPicker = New SelectSpeciesOptionPicker
            Controls.Add(mSpeciesPicker)
            mSpeciesPicker.ResultLabelText = "Apply this answer also to: "
            mSpeciesPicker.AriaLabelText = "This is a checkbox list for selecting one or more species that you wish to apply the above answer as well."
            mSpeciesPicker.Attributes.Add("aria-label", mSpeciesPicker.AriaLabelText)
            ...
            mOKButton.Text = "OK"
            mOKButton.Attributes.Add("aria-label", "Click here to apply the changes you made to this species.")
            mOKButton.Attributes.Add("onclick", "tinyMCE.triggerSave(false,true);")
            AddHandler mOKButton.Click, AddressOf btnOK_Click

            mCancelButton = New Button
            Controls.Add(mCancelButton)
            mCancelButton.Text = "Cancel"
            mOKButton.Attributes.Add("aria-label", "Click here to cancel any changes you might have made to this species.")
        ...
        Protected Overrides Sub Render(ByVal writer As System.Web.UI.HtmlTextWriter)
            ...
            writer.AddAttribute(HtmlTextWriterAttribute.Class, "govuk-table__header")
        ...
        Private Sub RenderSpeciesField(ByVal writer As HtmlTextWriter, ByVal field As FieldValueBase)
            Dim noTags = StripTagsExceptItalics(field.ToString())

            Dim stripped As String = Me.First50(noTags)

            writer.Write(stripped)
        End Sub

        Private Function First50(ByVal val As String) As String
            Dim limit = 50

            Return val.Substring(0, If((val.Length < limit), val.Length, limit))
        End Function
        ...
        Protected Sub btnOK_Click(ByVal sender As Object, ByVal e As EventArgs)
            ...
            SelectedSpeciesId = mSpeciesPicker.ExcludeItemId
