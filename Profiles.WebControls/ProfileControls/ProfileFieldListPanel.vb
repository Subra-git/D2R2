    ...
    Public Class ProfileFieldListPanel
        ...
        Protected Overrides Sub CreateChildControls()
            ...
            For Each field As FieldMetadataWrapper In mProfileVersionFieldList
                ...
                End Select
                Controls.Add(CType(fieldControl, Control))
            Next
        ...
        Protected Overrides Sub Render(ByVal writer As System.Web.UI.HtmlTextWriter)
            ...
            writer.AddAttribute(HtmlTextWriterAttribute.Class, "nestedMainContentClass")
            ...
            For Each currentControl As Control In Controls
                ...
                If currentField.IsVisible Then
                    writer.RenderBeginTag(HtmlTextWriterTag.Tr)
                    writer.RenderBeginTag(HtmlTextWriterTag.Td)

                    If currentField.DataType <> DataFieldType.MultiValueListType AndAlso Not String.IsNullOrEmpty(currentField.Name) Then
                        writer.AddAttribute(HtmlTextWriterAttribute.For, currentControl.Controls.Item(0).ClientID)
                    ...
                    writer.RenderEndTag() '/Label or strong
