Type.registerNamespace('Profiles.WebControls');

Profiles.WebControls.PersistentScrollPosition = function(element) {
	Profiles.WebControls.PersistentScrollPosition.initializeBase(this, [element]);
...
Profiles.WebControls.PersistentScrollPosition.prototype = {
	...
	initialize : function() {
		Profiles.WebControls.PersistentScrollPosition.callBaseMethod(this, 'initialize');
	...
	dispose : function() {				
		...
		Profiles.WebControls.PersistentScrollPosition.callBaseMethod(this, 'dispose');				
...
Profiles.WebControls.PersistentScrollPosition.registerClass('Profiles.WebControls.PersistentScrollPosition', Sys.UI.Behavior);
