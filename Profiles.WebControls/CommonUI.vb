...
Public Module CommonUI
    ...
    Public Function GetDiseaseReferenceTableInfoListStripped() As IEnumerable(Of KeyValuePair(Of String, String))
        Return GetDiseaseReferenceTableInfoList().Select(Function(x) New KeyValuePair(Of String, String)(x.Value, x.Value.StripHtmlTags))
    End Function
