...
Partial Class AffectedSpeciesSelector
    ...
    Public Sub SetAffectedSpecies(ByVal profiledSpecies As List(Of Guid), ByVal otherAffectedSpecies As List(Of Guid))
        ...
        Dim profiledSpeciesSelected = New List(Of String)
        Dim otherSpeciesSelected = New List(Of String)
    ...
    Private Sub AddTreeNodes(
        ...
        ByVal otherAffectedSpeciesNodeList As RadTreeNodeCollection,
        ByVal profiledParentChecked As Boolean,
        ByVal otherParentChecked As Boolean
    )
        ...
        For Each speciesChild As SpeciesInfo In speciesList
            ...
            AddTreeNodes(
                ...
                otherAffectedSpeciesNode.Nodes,
                profiledSpeciesNode.Checked,
                otherAffectedSpeciesNode.Checked
            )
    ...
    Public Sub ClearSelections()
        ...
        tvwOtherAffectedSpecies.UnselectAllNodes()
        tvwOtherAffectedSpecies.ExpandAllNodes()
        tvwOtherAffectedSpecies.UncheckAllNodes()
        tvwProfiledSpecies.UnselectAllNodes()
        tvwProfiledSpecies.UncheckAllNodes()
        tvwProfiledSpecies.ExpandAllNodes()

        otherAffectedSpeciesSelected.InnerText = String.Empty
        profiledSpeciesSelected.InnerText = String.Empty
    End Sub
End Class
