...
Partial Class MaintainGlobalUsers
    ...
    Private Sub DisplayPanelControls(ByVal displayControls As Boolean)
        ...
        chkSubscribeEmail.Enabled = displayControls
        chkSubscribeEmail.Visible = displayControls
    ...
    Private Sub SwitchToGlobalUserEditView(ByVal currentUser As GlobalUser)
        ...
        txtFullName.Text = currentUser.FullName
        txtOrganisation.Text = currentUser.Organisation
        chkSubscribeEmail.Checked = currentUser.SubscribedToReviewEmails
        ddlRole.Text = MapUserRoleToDropdownList(currentUser.UserRole)
        ddlRole.Enabled = (Not currentUser.Id = identity.UserId) 'cannot change your own role
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Page.IsValid Then
            ...
            Try
                ...
                CurrentGlobalUser.SubscribedToReviewEmails = chkSubscribeEmail.Checked
                CurrentGlobalUserList.ApplyEdit()
                CurrentGlobalUserList.Save()
    ...
    Private Sub bottomPaginator_PageChanged(sender As Object, e As PageChangedEvent) Handles bottomPaginator.PageChanged
        ...
        grdGlobalUsers.PageIndex = bottomPaginator.CurrentPage - 1
        RefreshPage()
	...
	Private Sub RefreshPage()
        grdGlobalUsers.DataBind()
        bottomPaginator.TotalPages = grdGlobalUsers.PageCount
