...
Partial Class ShowPublishedProfile
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Dim profileVersion = ProfileVersionInfo.GetProfileVersionInfo(profileVersionId)
		...
		Response.DownloadPdfBytes(pdfData, $"{profileVersion.FullTitlePlainText}_{reportInfo.DisplayName}")
	End Sub
End Class
