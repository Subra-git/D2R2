<%@ Page Language="VB" MasterPageFile="~/ProfilesTemplate.master" AutoEventWireup="false" Inherits="Profiles.Web.MaintainPrioritisationVariables"
    Title="Maintain profile prioritisation variables" Codebehind="MaintainPrioritisationVariables.aspx.vb" %>
...
<asp:Content ID="mainContent" ContentPlaceHolderID="cphMain" runat="Server">
        ...
        <ContentTemplate>
            ...
            <div class="collapsePanel">
                <div class="d-flex align-items-center">
                    <asp:Label runat="server" CssClass="govuk-label me-2 mb-0 d-inline">Calculate prioritisation scores for draft profiles</asp:Label>
                    <asp:Button CssClass="govuk-button mb-0" ID="btnCalculateDraftPrioritisation" runat="server" Text="Go" />
                </div>
    ...
    <asp:UpdatePanel ID="updatePanelPrioritisation" runat="server">
        ...
        <ContentTemplate>
            &nbsp;
            <div align="right">
                <asp:Button CssClass="govuk-button govuk-button--secondary" ID="btnUpdate" runat="server" Text="Update" CausesValidation="true" ValidationGroup="RankingRange"></asp:Button><br />
                <asp:Label ID="lblError" runat="server" CssClass="ErrorLabel" EnableViewState="False"></asp:Label><br />
            </div>
            <div class="collapsePanelHeader">
                Edit ranking range</div>
            <div class="collapsePanel" style="padding-top: 5px; padding-bottom: 5px;">
                <asp:ValidationSummary ID="valsumRankingRange" runat="server" ValidationGroup="RankingRange" />
                <table>
                    <tbody>
                        <tr>
                            <td>
                                <asp:Label CssClass="govuk-label mb-0 me-2"  runat="server" Text="Lower bound: "></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtLowerBound" runat="server" CausesValidation="True" MaxLength="3"
                                    Width="50px" ValidationGroup="RankingRange" CssClass="govuk-input"></asp:TextBox>
                            </td>
                            <td style="width: 16px">
                            ...
                            <td>
                                <asp:Label CssClass="govuk-label mb-0 me-2" runat="server" Text="Upper bound: "></asp:Label>
                            </td>
                            <td>
            ...
            <div style="margin-top: 10px; float: left; width: 100%; height: 100%;">
                <div style="margin-top: 10px; margin-bottom: 10px; width: 100%" class="govuk-form-group">
                    ...
                    <asp:DropDownList ID="ddlPrioritisationCategories" runat="server" CausesValidation="True"
                        ...
                        DataValueField="Id" AppendDataBoundItems="true" CssClass="govuk-select">
                        <asp:ListItem Text="Please select..." Value="0"></asp:ListItem>
                    </asp:DropDownList>
                    <asp:Button CssClass="govuk-button govuk-button--secondary" ID="btnPrint" runat="server" Text="Print category variables"
                        Enabled="False"></asp:Button>
                    &nbsp;
                    <asp:Button CssClass="govuk-button govuk-button--secondary" ID="btnExportScoreData" runat="server" Text="Export score data"
                        Enabled="False"></asp:Button>
                    &nbsp;
                    <asp:Button CssClass="govuk-button govuk-button--secondary" ID="btnExportAll" runat="server"
            ...
            <asp:Panel ID="pnlCriterionValues" runat="server" Width="100%" Visible="false">
                ...
                <div class="collapsePanel">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtCriterionName" runat="server" CausesValidation="True" Width="95%"
                                        Rows="3" ValidationGroup="Criterion"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="valCriterionNameReq" ControlToValidate="txtCriterionName"
                                        ...
                                        ValidationGroup="Criterion" CssClass="govuk-tag--red">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtCriterionWeight" runat="server" CausesValidation="True" MaxLength="3"
                                        Width="50px" ValidationGroup="Criterion" CssClass="govuk-input"></asp:TextBox>
                                </td>
                                <td>
                            ...
                            <asp:TemplateField HeaderText="Score">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtScore" runat="server" CausesValidation="True" MaxLength="3" Width="50px"
                                        Text='<%# Eval("Score") %>' ValidationGroup="Criterion" CssClass="govuk-input"></asp:TextBox>
                    ...
                    &nbsp;
                    <div align="right">
                        <asp:Button CssClass="govuk-button" ID="btnSaveCriterion" OnClick="btnSaveCriterion_Click" runat="server"
                            Text="OK" ValidationGroup="Criterion"></asp:Button>
                        <asp:Button CssClass="govuk-button govuk-button--secondary" ID="btnCancelCriterion" OnClick="btnCancelCriterion_Click" runat="server"
