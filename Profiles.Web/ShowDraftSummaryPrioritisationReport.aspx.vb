...
Partial Class ShowDraftSummaryPrioritisationReport
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Dim pdfData As Byte() = profileVersion.GetSummaryPrioritisationReport()

		If pdfData Is Nothing Then
			Throw New InvalidOperationException("Could not find a PDF for the specified profile version.")
		End If

		Dim reportName = $"{profileVersion.FullTitlePlainText}({profileVersion.Status})_{profileVersion.Version}_Summary prioritisation report"
