...
<%@ Import Namespace="Profiles.WebControls" %>

<script runat="server">

    Sub Application_Start(ByVal sender As Object, ByVal e As EventArgs)
        ' Code that runs on application startup        
        StructureMap.StructureMapConfiguration.AddRegistry(New Profiles.Web.Profiles.Web.IoC.WebsiteRegistry())
    End Sub
    ...
    Sub Application_Error(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim errorPageUrl As String = HandleError()
        Server.ClearError()
        Response.Clear()
