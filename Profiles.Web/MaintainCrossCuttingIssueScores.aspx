<%@ Page Language="VB" MasterPageFile="~/ProfilesTemplate.master" AutoEventWireup="false" Inherits="Profiles.Web.MaintainCrossCuttingIssueScores"
    Title="Maintain cross-cutting issue scores" Codebehind="MaintainCrossCuttingIssueScores.aspx.vb" %>
...
<asp:Content ID="mainContent" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <asp:UpdatePanel ID="updatePanelPrioritisation" runat="server">
        ...
        <ContentTemplate>
            &nbsp;
            <div align="right">
                <asp:Button CssClass="govuk-button" ID="btnUpdate" runat="server" Text="Update"></asp:Button><br />
            ...
            <div style="float: left; width: 100%">
                <div style="margin-bottom: 10px; width: 100%">
                    ...
                    <asp:DropDownList ID="ddlSpeciesPrioritisationCategories" CssClass="govuk-select" runat="server" CausesValidation="True"
                    ...
                    <asp:GridView ID="grdSpeciesCriterionValues" runat="server" Width="100%" DataSourceID="dsSpeciesPrioritisationCriterionValueList"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Score">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtScore" CssClass="govuk-input" runat="server" CausesValidation="True" MaxLength="3" Width="50px"
