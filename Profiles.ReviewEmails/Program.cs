...
namespace Profiles.ReviewEmails
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            StructureMap.ObjectFactory.Configure(a =>
            {
                ...
                a.ForRequestedType<IEmailBusiness>().TheDefaultIsConcreteType<EmailBusiness>();
                a.ForRequestedType<IGlobalSettings>().TheDefaultIsConcreteType<WebConfigGlobalSettings>();
            });

            ProfilesLibrary.ProfilesPrincipal.Login(ConfigurationManager.AppSettings["CslaAuthentication.User"]);
