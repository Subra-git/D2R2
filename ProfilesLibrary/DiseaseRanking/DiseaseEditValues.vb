...
<Serializable()> _
Public Class DiseaseEditValues
    Inherits BusinessBase(Of DiseaseEditValues)
...
#Region " Business Methods "
    ...
    Public Overrides Function Save() As DiseaseEditValues
...
#Region " Factory Methods "
    ...
    Public Shared Function DiseaseFilterUpdate(ByVal id As Long) As DiseaseEditValues
        ...
        Return DataPortal.Create(Of DiseaseEditValues)(New DeleteFilterCrt(id))
    End Function
...
#Region " Data Access "
    ...
    Private Class DeleteFilterCrt
        Private mDiseaseNumber As Long

        Public ReadOnly Property DiseaseNumberFetched() As Long
            Get
                Return mDiseaseNumber
            End Get
        End Property

        Public Sub New(ByVal DiseaseNumberF As Long)
            mDiseaseNumber = DiseaseNumberF
        End Sub
    ...
    Protected Overrides Sub DataPortal_Insert()
        ...
        db.UpdateDiseaseFilterValue(change)
    ...
    Private Overloads Sub DataPortal_Create(ByVal dataCri As DeleteFilterCrt)
        ...
        Dim change As New DataContracts.DiseaseRankingValues() With { _
            .FilterNumber = dataCri.DiseaseNumberFetched _
        }

        db.UpdateDisableDiseaseFilterValue(change)
