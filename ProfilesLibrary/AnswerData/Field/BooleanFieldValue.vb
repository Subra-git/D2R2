...
#Region " Business Methods "
    ...
    Private mFieldValue As Nullable(Of Boolean)
    ...
    Public Property FieldValue() As Nullable(Of Boolean)
    ...
    Public Overrides Sub SetValue(value As Object)
        If TypeOf value IsNot Boolean Then
            Throw New ArgumentException("Boolean field value is required.")
        End If

        FieldValue = DirectCast(value, Boolean)
    End Sub
    ...
    Public Overrides Function ValuesEqual(ByVal otherFieldValue As FieldValueBase) As Boolean
        ...
        If Not TypeOf otherFieldValue Is BooleanFieldValue Then
            Return False
        End If

        Return mFieldValue.Equals(DirectCast(otherFieldValue, BooleanFieldValue).FieldValue)
...
#Region " Data Access "
    ...
    Friend Sub InitializeValue(ByVal fieldValue As Boolean)
    ...
    Friend Overrides Sub GetUpdate(ByVal question As QuestionBase, ByVal row As QuestionRow, ByVal species As QuestionSpecies, ByVal changeset As DataContracts.AnswerDataChangeSet, ByVal dtoFieldValueUpdate As DataContracts.FieldValueUpdate)
        ...
        If mFieldValue.HasValue Then
            dtoFieldValueUpdate.BooleanValue = CBool(mFieldValue.Value)
            dtoFieldValueUpdate.ParameterName = "@BooleanValue"
        End If
