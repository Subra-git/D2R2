...
Friend MustInherit Class AnswerComparisonDifferenceTable
    Inherits Table

    Public Shared Function GetAnswerTable(ByVal questionLeft As QuestionBase, ByVal questionRight As QuestionBase, ByVal headingLevel As Integer, ByVal base As PdfBase) As AnswerComparisonDifferenceTable
        If TypeOf questionLeft Is PerSpeciesQuestion Then
            Return New PerSpeciesAnswerComparisonDifferenceTable(questionLeft, questionRight, headingLevel, base)
        ElseIf TypeOf questionLeft Is RepeatingQuestion Then
            Return New RepeatingAnswerComparisonDifferenceTable(questionLeft, questionRight, headingLevel, base)
        Else
            Return New StandardAnswerComparisonDifferenceTable(questionLeft, questionRight, headingLevel, base)
        End If
    End Function
